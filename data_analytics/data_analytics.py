...
def generate_all_charts(style):
    ...
    plt.savefig(img_dir+'users_N_lessons.png')
    # plt.show()
    ...
    plt.tight_layout()
    plt.savefig(img_dir+'lessons_per_day.png')
    # plt.show()
    ...
    plt.xticks(rotation=45)
    plt.tight_layout()
    plt.savefig(img_dir+'user_unique_active_days.png')
    # plt.show()
    ...
    plt.tight_layout()
    plt.savefig(img_dir+'user_activity_binary.png')
    # plt.show()
    ...
    plt.savefig(img_dir+'relisten_pie.png')
    # plt.show()
    ...
    plt.savefig(img_dir+'lesson_distribution_pie.png')
    # plt.show()
