final Map<String, List<String>> scenarioKeywords = {
  ...
  "Two friends debating whether brunch is overrated.": ["friends", "debating", "brunch", "breakfast", "food"],
  "A barista explaining latte art techniques to a curious customer.": ["barista", "latte", "art", "coffee", "customer"],
  "A couple planning their first camping trip together.": ["couple", "planning", "camping", "trip", "together"],
  "A neighbor asking for help assembling IKEA furniture.": ["neighbor", "asking", "help", "furniture", "assemble"],
  "A teenager nervously asking their crush to prom.": ["teenager", "asking", "crush", "prom", "nervous"],
  "Two coworkers arguing over how to decorate the office for a holiday.": ["coworkers", "arguing", "decorate", "office", "holiday"],
  "A beginner taking their first salsa dancing lesson.": ["beginner", "salsa", "dancing", "lesson", "first"],
  "A dad explaining how to tie a tie before a school dance.": ["dad", "explaining", "tie", "school", "dance"],
  "A dog walker losing track of how many dogs they’re walking.": ["dog", "walker", "track", "how", "many"],
  "A group of friends stuck in an escape room.": ["group", "friends", "escape", "room", "puzzle"],
  "A couple trying to assemble a barbecue grill without instructions.": ["couple", "assemble", "barbecue", "grill", "instructions"],
  "Two travelers sharing snacks on a long train ride.": ["travelers", "sharing", "snacks", "train", "ride"],
  "A yoga class accidentally held in a toddler gym room.": ["yoga", "class", "accidentally", "toddler", "gym"],
  "A family discussing vacation destinations over dinner.": ["family", "discussing", "vacation", "destinations", "dinner"],
  "Two roommates arguing about whose turn it is to take out the trash.": ["roommates", "arguing", "turn", "trash", "chores"],
  "A grandma teaching her grandchild how to bake cookies.": ["grandma", "teaching", "bake", "cookies", "grandchild"],
  "Someone realizing they’ve worn mismatched shoes to work.": ["shoes", "mismatched", "realizing", "work", "oops"],
  "A child explaining their imaginary friend to a babysitter.": ["child", "explaining", "imaginary", "friend", "babysitter"],
  "A couple disagreeing on how to name their cat.": ["couple", "disagreeing", "name", "cat", "pet"],
  "A music teacher tuning instruments before a chaotic school concert.": ["teacher", "music", "tuning", "instruments", "concert"],
  "A tourist realizing they ordered something weird off the menu.": ["tourist", "menu", "ordered", "weird", "food"],
  "Two best friends shopping for outfits for a theme party.": ["friends", "shopping", "outfits", "theme", "party"],
  "A new employee trying to survive their first video call.": ["employee", "first", "video", "call", "awkward"],
  "A teenager explaining memes to their parents.": ["teenager", "explaining", "memes", "parents", "funny"],
  "Someone trying to sneak vegetables into a picky eater’s meal.": ["vegetables", "sneak", "picky", "eater", "meal"],
  "A person asking their neighbor to water their plants in exchange for cookies.": ["asking", "neighbor", "water", "plants", "cookies"],
  "A friend asking for help writing a dating profile.": ["friend", "help", "writing", "dating", "profile"],
  "A toddler refusing to eat anything but spaghetti.": ["toddler", "refusing", "eat", "spaghetti", "meal"],
  "A coworker giving a presentation while their cat climbs on their laptop.": ["coworker", "presentation", "cat", "laptop", "distraction"],
  "A couple testing each other on trivia during a road trip.": ["couple", "trivia", "road", "trip", "quiz"],
  "A person losing their phone at a concert.": ["person", "losing", "phone", "concert", "search"],
  "A book club that never talks about the book.": ["book", "club", "talks", "off-topic", "reading"],
  "Someone who forgot it was their turn to cook for game night.": ["forgot", "turn", "cook", "game", "night"],
  "A person trying to learn how to roller skate at the park.": ["roller", "skate", "learn", "park", "fall"],
  "A bar regular teaching a first-timer how to play darts.": ["bar", "regular", "teaching", "darts", "game"],
  "Two cousins creating a secret handshake.": ["cousins", "creating", "secret", "handshake", "fun"],
  "A friend pretending to know a movie they’ve never seen.": ["friend", "pretending", "know", "movie", "seen"],
  "A grandparent learning to use emojis.": ["grandparent", "learning", "emojis", "text", "funny"],
  "A college student navigating their first shared kitchen.": ["college", "student", "shared", "kitchen", "first"],
  "A couple building IKEA furniture without fighting (almost).": ["couple", "building", "furniture", "ikea", "fight"],
  "Two people trying to beat the heat during a summer blackout.": ["people", "heat", "summer", "blackout", "cool"],
  "A neighbor trying to return a drone that crash-landed in their yard.": ["neighbor", "drone", "return", "crash", "yard"],
  "A dog that interrupts a serious conversation by demanding attention.": ["dog", "interrupts", "attention", "conversation", "funny"],
  "A group of friends doing a terrible karaoke rendition of a classic song.": ["friends", "karaoke", "terrible", "song", "fun"],
  "A teacher realizing their students know more TikTok dances than they do.": ["teacher", "students", "tiktok", "dance", "surprise"],
  "A baker forgetting whether they added salt or sugar.": ["baker", "forgetting", "salt", "sugar", "oops"],
  "A hiking group realizing they brought too many snacks and no map.": ["hiking", "group", "snacks", "map", "lost"],
  "A birthday party where everyone shows up in the same outfit.": ["birthday", "party", "same", "outfit", "awkward"],
  "A florist helping someone pick flowers for a date.": ["florist", "flowers", "pick", "date", "romance"],
  "A kid selling lemonade with suspiciously creative pricing strategies.": ["kid", "lemonade", "selling", "pricing", "creative"]
};
