...
class _DialogueListState extends State<DialogueList> {
  ...
  final ValueNotifier<List<dynamic>> _dialogueNotifier =
  ...
  void initState() {
    ...
    if (widget.useStream && widget.documentID.isNotEmpty) {
      _dialogueStream = FirebaseFirestore.instance
      ...
      if (currentDialogueIndex >= 0) {
        ...
        WidgetsBinding.instance.addPostFrameCallback((_) {
          if (_scrollController.hasClients && currentDialogueIndex > 0) {
            const itemHeight =
                120.0; // Approximate height of each dialogue item
  ...
  bool _areDialoguesEqual(List<dynamic> list1, List<dynamic> list2) {
    ...
    for (int i = 0; i < list1.length; i++) {
      if (list1[i]['target_language'] != list2[i]['target_language'] ||
          list1[i]['native_language'] != list2[i]['native_language']) {
        return false;
      }
    }
    return true;
    ...
    return RepaintBoundary(
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isEven ? const Color(0xFF0F3D37) : const Color(0xFF1A4D3A),
          borderRadius: BorderRadius.circular(15),
          boxShadow: [
            BoxShadow(
              color: shouldHighlight
                  ? colorScheme.onPrimaryContainer.withOpacity(0.5)
                  : colorScheme.shadow.withOpacity(0.6),
              spreadRadius: 1,
              blurRadius: 4,
                  ...
                  return Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        fontWeight: shouldHighlight || match
                            ? FontWeight.bold
                            : FontWeight.normal,
                        decoration: match
        ...
        child: StreamBuilder<QuerySnapshot>(
          ...
          builder:
            ...
            if (snapshot.connectionState == ConnectionState.waiting &&
                _dialogueNotifier.value.isEmpty) {
            ...
            if (snapshot.hasData && snapshot.data!.docs.isNotEmpty) {
              ...
              if (data.containsKey('dialogue')) {
                ...
                if (!_areDialoguesEqual(
                    newDialogueData, _dialogueNotifier.value)) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _buildDialogueItem(
                        context, dialogueData[index], index);
                  },
                );
              },
            );
