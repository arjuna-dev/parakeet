                              ...
                              children: [
                                Column(
                                  children: snapshot.data!.docs
                                    ...
                                    List<dynamic> turns = [];
                                    if (smallJsonDocument
                                        .containsKey("dialogue")) {
                                      turns =
                                          smallJsonDocument["dialogue"] ?? [];
                                      script =
                                          script_generator.createFirstScript(
                                              smallJsonDocument["dialogue"] ??
                                                  []);
                                    }
                                            ...
                                            decoration: BoxDecoration(
                                              color: isEven
                                                  ...
                                                  : const Color.fromARGB(
                                                      ...
                                                      62,
                                                      59,
                                                      124), // Different background colors for even/odd
                                                              ...
                                                              child:
                                                                  isSpecialWord
                                                                      ? Showcase
                                                                          ...
                                                                          targetPadding: const EdgeInsets
                                                                              .all(
                                                                              8),
                                                                          targetShapeBorder:
                                                                              const CircleBorder(),
